							...
							<form class="" method="post"
								...
								<div
									...
									<input type="text" class="form-control shadow-none"
										...
										value="<%=u2.getNome()%>" required> <input
										type="email" class="form-control shadow-none"
								...
								<div
									...
									<input type="password" class="form-control shadow-none"
										...
										value="<%=u2.getSenha()%>" required> <input
										type="text" class="form-control shadow-none"
										id="recipient-name" placeholder="Nível de Acesso"
										name="accessLevel" value="<%=u2.getNivelAcesso()%>">
				...
				<table class="table">
					<thead
						...
						<tr>
							...
							<th scope="Nível Acesso">Nível de Acesso</th>
