...
<body>
	...
	<% Usuario u2=(Usuario) request.getAttribute("redirecionador2"); %>
	<div class="wrapper">
		<!-- Sidebar  -->
		<nav id="sidebar">
			...
			<ul class="list-unstyled components">
				...
				<li><a href="#pageSubmenu" data-toggle="collapse" aria-expanded="false"
					...
					<ul class="collapse list-unstyled" id="pageSubmenu">
						<li>
							<div class="icons-menu">
								<i class="fa-solid fa-arrow-up"></i> <a href="relatorio-entrada.jsp">Entrada</a>
							</div>
						</li>
						<li>
							<div class="icons-menu">
								<i class="fa-solid fa-arrow-down"></i> <a href="relatorio-saida.jsp">Saída</a>
							</div>
						</li>
					</ul>
				</li>
		...
		<main id="content">
			...
			<header class="d-flex align-items-center gap-4 justify-content-between"
				...
				<button type="button" class="btn text-white" data-toggle="modal"
					...
					style="background-color: #2678D1;" id="btnProduto">Atualizar
					Usuários</button>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form class="" method="post"
								action="ExecutaAlterarUsuarioServlet">
								<div
									class="form-group d-flex gap-3 mb-2 flex-column  columnInput">
									<input type="text" class="form-control shadow-none"
										id="recipient-name" placeholder="Nome do Usuário"
										name="name" value="<%=u2.getNome()%>" required>
									<input type="email" class="form-control shadow-none"
										id="recipient-name" placeholder="email@dominio.com"
										name="login" value="<%=u2.getLogin()%>" required>
								</div>
								<div
									class="form-group d-flex gap-3 mb-2 flex-column  columnInput">
									<input type="password" class="form-control shadow-none"
										id="recipient-name" placeholder="senha"
										name="password" value="<%=u2.getSenha()%>" required>
									<input type="hidden" name="Id"
										value="<%=u2.getId()%>"></input>
								</div>
								<div class="modal-footer">
									<button type="submit" class="btn text-white w-100"
										style="background-color: #2678D1; letter-spacing: 7px; padding: 12px 0; font-weight: 600;">ATUALIZAR</button>
								</div>
							</form>
						</div>
					</div>
