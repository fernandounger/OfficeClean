...
<head>
	...
	<link
		...
		rel="stylesheet">
	<title>Relatórios de Saída - OCT</title>
	...
	<link rel="stylesheet" href="./css/relatoriosaida.css">
...
<body>
	...
	<% if (session.getAttribute("usuarioLogado")==null) { RequestDispatcher
		rd=request.getRequestDispatcher("login.jsp"); rd.forward(request, response); } Usuario u=(Usuario)
	...
	<div class="wrapper">
		...
		<nav id="sidebar">
			<div class="sidebar-header">
				<a href="#"> <img src="./img/oct.png" alt="Logo Office Clean Tech" style="height: 60px;">
				</a>
			</div>
			...
			<header class="d-flex align-items-center gap-4 justify-content-between" id="header__btn">
				<div class="search-container">
					<form action="" method="post">
						<input type="text" placeholder="Buscar saída" name="search">
						<button type="submit">
				...
				<button type="button" class="btn text-white" data-toggle="modal" data-target="#exampleModal"
					data-whatever="@mdo" style="background-color: #2678D1;" id="btnProduto"><i
						class="fa-solid fa-file"></i> GERAR RELATÓRIO</button>
			</header>
			<!-- Tabela de Saída -->
			<div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar"
				style="margin-top: 40px; border-radius: 8px; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.15);">
				<table class="table">
					<thead style="box-shadow: 0px 4px 4px rgb(0 0 0/ 5%); border-radius: 8px;">
						<tr>
