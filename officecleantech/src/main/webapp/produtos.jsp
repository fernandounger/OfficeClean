							...
							<body>
								...
								<% if (session.getAttribute("usuarioLogado")==null) { RequestDispatcher
									...
									<div class="wrapper">
										...
										<nav id="sidebar">
											...
											<ul class="list-unstyled components">
												...
												<li><a href="#pageSubmenu" data-toggle="collapse" aria-expanded="false"
														class="dropdown-toggle ">Relat�rios</a>
														...
														<li>
															<div class="icons-menu">
																<i class="fa-solid fa-arrow-down"></i> <a
																	href="relatorio_saida.jsp">Sa�da</a>
															</div>
														</li>
													</ul>
												</li>
										...
										<main id="content">
											...
											<header class="d-flex align-items-center gap-4 justify-content-between"
												...
												<div>
													...
													<button type="button" class="btn text-white" data-toggle="modal"
														data-target="#exampleModal" data-whatever="@mdo"
														style="background-color: #d65555;" id="btnProduto">Baixar
														Produto
													</button>
												</div>
															...
															<form class="" method="post" action="ProdutoServlet">
																<div
																	...
																	<input type="number"
																		...
																		id="recipient-name" name="codigoBarra"
																		placeholder="C�digo do produto"> <input
										...
										id="recipient-name" placeholder="Valor Unidade">--> <select class="form-select shadow-none"
																		...
																		<option value="Acess�rios de Limpeza">Acess�rios
																			de Limpeza</option>
																		<option value="Produtos Qu�micos de Limpeza">
																			Produtos Qu�micos de Limpeza</option>
										...
										id="recipient-name" placeholder="Estoque Atual"> --> <select class="form-select shadow-none"
																		aria-label="Default select example"
																		style="padding: 0.375rem 0.75rem"
																		name="fornecedor">
																		<option selected>Fornecedor</option>
																		<% FornecedorController fcontroller=new
																			FornecedorController();
																			ArrayList<Fornecedor> flista =
																			fcontroller.listar(nomeBuscar);
																...
																<div
																	class="form-group d-flex gap-4 mb-2 flex-row columnInput">
																	<input type="text" class="form-control shadow-none"
																		id="recipient-name" name="descricao"
																		placeholder="Descri��o"> <!-- <input
										type="text" class="form-control shadow-none"
										id="recipient-name" placeholder="Localiza��o">-->
																</div>
																<div class="form-group d-flex gap-3 mb-2 flex-row">
																	<input type="text" class="form-control shadow-none"
																		id="recipient-name" name="estoqueMaximo"
																		placeholder="Quantidade M�xima"> <input
																		type="text" class="form-control shadow-none"
																		id="recipient-name" name="estoqueMinimo"
																		placeholder="Quantidade M�nima">
																</div>
																<div class="modal-footer">
																	<button type="submit" class="btn text-white"
																		style="background-color: #77B800;">Salvar
																		Produto</button>
																</div>
															</form>
														</div>
																...
																<td>
																	<div class="d-flex gap-2">
																		<div class="text-primary" data-toggle="modal"
																			...
																			<a
																				href="InicioAlterarProduto?codigoBarra=<%= p.getCodigoBarra() %>"><i
																					class="fa-solid fa-pen-to-square"></i></a>
																		</div>
																		<div class="text-danger">
																			<a href="ExcluirProduto?codigoBarra=<%= p.getCodigoBarra() %>"
