			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				<div class="container-fluid">
					<button type="button" id="sidebarCollapse"
						class="btn text-white" style="background-color: #77B800;">
							...
							<form class="" method="post" action="ProdutoServlet">
								...
								<div
									...
									<select class="form-select shadow-none"
										...
										<option value="Acessórios de Limpeza">
											Acessórios de Limpeza</option>
										<option
											value="Produtos Químicos de Limpeza">
											Produtos Químicos de Limpeza</option>
								...
								<div class="form-group d-flex gap-3 mb-2 flex-row">
									<input type="text"
										...
										placeholder="Quantidade Máxima"> <input
