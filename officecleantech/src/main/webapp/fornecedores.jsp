							...
							<form class="" method="post" action="FornecedorServlet">
								<div
									...
									<input type="text" class="form-control shadow-none"
										...
										placeholder="Nome do fornecedor"> <input type="email"
										class="form-control shadow-none" id="recipient-name"
										name="email" placeholder="email@dominio.com">
								</div>

								<div
									class="form-group d-flex gap-3 mb-2 flex-column  columnInput">
									<input type="number" class="form-control shadow-none"
										id="recipient-name" name="telefone" placeholder="Telefone">
									<input type="number" class="form-control shadow-none"
										id="recipient-name" name="cnpj" placeholder="CNPJ"> <input
								...
								<div class="form-group d-flex gap-4 mb-2 flex-row columnInput">
									<input type="number" class="form-control shadow-none"
										id="recipient-name" name="cep" placeholder="CEP"> <input
										type="text" class="form-control shadow-none"
										id="recipient-name" name="bairro" placeholder="Bairro">
								...
								<div class="form-group d-flex gap-4 mb-2 flex-row columnInput">
									...
									</select> <input type="text" class="form-control shadow-none"
										id="recipient-name" name="cidade" placeholder="Cidade">
								</div>

								<div class="form-group d-flex gap-4 mb-2 flex-row columnInput">
									<input type="text" class="form-control shadow-none"
										id="recipient-name" name="logradouro" placeholder="Logradouro">
									<input type="number" class="form-control shadow-none"
							...
							<td>
								<div class="d-flex gap-2">
									<div class="text-primary" data-toggle="modal"
										...
										<a href="InicioAlterarFornecedor?id=<%=f.getId()%>  "><i
