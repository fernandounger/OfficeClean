			...
			<ul class="list-unstyled components">
				...
				<li id="li-logoff">
					<div class="icons-menu logoff">
						<i class="fa-solid fa-power-off"></i> <a href="#">Sair</a>
					</div>
				</li>
			</ul>
			...
			<header
				...
				<div class="search-container">
					<form action="" method="post">
						<input type="text" placeholder="Buscar fornecedor" name="busca"
							<%=nomeBusca%>>
						<button type="submit">
							...
							<form class="">
								<div
									...
									<input type="text" class="form-control shadow-none"
										id="recipient-name" placeholder="Nome do fornecedor" name="name">
									<input type="email" class="form-control shadow-none"
										id="recipient-name" placeholder="email@dominio.com" name="email">
								</div>

								<div
									class="form-group d-flex gap-3 mb-2 flex-column  columnInput">
									<input type="number" class="form-control shadow-none"
										id="recipient-name" placeholder="Telefone" name ="telephone"> <input
										type="number" class="form-control shadow-none"
										id="recipient-name" placeholder="CNPJ" name="cnpj"> <input
										type="text" class="form-control shadow-none"
										id="recipient-name" placeholder="Site" name="site">
								</div>
				...
				<table class="table">
					<thead
						...
						<tr>
							...
							<th scope="Complemento">Complemento</th>
						</tr>
					</thead>
					<tbody>
						...
						ArrayList<Fornecedor> fornecedores = dao.listar(nomeBusca);
						...
						<tr>
							...
							<td><%=f.getTelefone()%></td>
							<td><%=f.getEmail()%></td>
							<td><%=f.getEndereco().getEstado()%></td>
							<td><%=f.getEndereco().getCidade()%></td>
							<td><%=f.getEndereco().getCep()%></td>
							<td><%=f.getEndereco().getBairro()%></td>
							<td><%=f.getEndereco().getLogradouro()%></td>
							<td><%=f.getEndereco().getNumero()%></td>
							<td><%=f.getEndereco().getComplemento()%></td>
